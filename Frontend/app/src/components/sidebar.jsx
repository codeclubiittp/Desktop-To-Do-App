...
const StyledSidebar = styled.div`
  ...
  width: ${(props) => (props.isOpen ? "250px" : "30px")};
  ...
  .item {
    ...
    .dropdown {
      ...
      a {
        color: #6A9C89;        /* Inherits text color from parent */
        margin: 5px 0;
        display: block;
        font-size: 14px;
  ...
  .toggle-btn {
    position: absolute;
    left: ${(props) => (props.isOpen ? "200px" : "1px")};
    border: none;
    background-color: #DCDEDC;
    margin-top: -9px;
    border-radius: 5px;
...
function Sidebar() {
  ...
  return (
    ...
    <StyledSidebar isOpen={isOpen} dropdownOpen={dropdownOpen}>
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="28px" height="28px" viewBox="0 0 16 16"><path fill="#16423C" fill-rule="evenodd" d="M6 3.5h6A1.5 1.5 0 0 1 13.5 5v6a1.5 1.5 0 0 1-1.5 1.5H6zm-1.5 0H4A1.5 1.5 0 0 0 2.5 5v6A1.5 1.5 0 0 0 4 12.5h.5zM1 5a3 3 0 0 1 3-3h8a3 3 0 0 1 3 3v6a3 3 0 0 1-3 3H4a3 3 0 0 1-3-3z" clip-rule="evenodd"/></svg>          
      </button>
      <div className="b">
        <img src="https://cdn-icons-png.flaticon.com/512/149/149071.png" alt="Icon Image"/>         
        <h3 className="user">Jaimin</h3>
      </div>
      <div className="item">
